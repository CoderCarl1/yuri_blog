...
function displaysJSON(documentId: string, schemaType: string, S: StructureBuilder){
...
export default function main(S: StructureBuilder, { documentId, schemaType }: DefaultDocumentNodeContext) {
